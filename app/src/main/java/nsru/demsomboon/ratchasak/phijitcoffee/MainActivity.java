...
private EditText userEditText, passwordEditText;
    ...
    private static final String urlPromote="http://swiftcodingthai.com/aon/Image/FB_IMG_1487407447796.png";
    ...
    public class ConnectrdJSON extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                Request request = builder.url("http://swiftcodingthai.com/aon/getUser.php").build();
